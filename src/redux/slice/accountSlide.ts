...
export const accountSlide = createSlice({
    ...
    reducers: {
        ...
        //     console.log("check data ==> " ,action.payload.result.email);
        ...
        setUserLoginInfo: (state, action) => {
            ...
            if (action?.payload?.result) {
                state.user._id = action.payload.result._id;
                state.user.email = action.payload.result.email;
                state.user.name = action.payload.result.name;
                state.user.role = action?.payload?.result?.role;
                state.user.permissions = action?.payload?.result?.permissions;
            } else {
                console.error("Không có result trong action payload");
            }
        },
